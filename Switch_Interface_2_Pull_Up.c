...
void main()
{
    ...
    while(1)
    {
        ...
        switch(val)
        {
            case 0x0E : PORTD = 0x10; // 0001 0000 RD4 - ON & RD2 - OFF
                break;
            case 0x0D : PORTD = 0x04; // 0000 0100 RD4 - OFF & RD2 - ON
                break;
            case 0x0B: PORTD = 0x14; // 0001 0100 RD4 - ON & RD2 - ON
                break;
            case 0x07 : PORTD = 0x00; // 0000 0000 RD4 - OFF & RD2 - OFF
                break;
            case 0x0F : PORTD = 0x00; // 0000 0000 RD4 - OFF & RD2 - OFF (DEFAULT CASE)
                break;
        }
    }
}
